...
I used glimpse() function to view each dataset. Clean all date, time and date time columns. Rename all date columns to logDate and time columns to logTime for ease of merge later. 
